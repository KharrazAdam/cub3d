...
/*   Updated: 2023/03/10 21:44:02 by akharraz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_tuple	matrice_tuple_multiplication(t_matrice mat, t_tuple tup)
{
	...
	ret.x = (mat.mat[0][0] * tup.x) + (mat.mat[0][1] * tup.y) + \
	(mat.mat[0][2] * tup.z) + (mat.mat[0][3] * tup.w);
	ret.y = (mat.mat[1][0] * tup.x) + (mat.mat[1][1] * tup.y) + \
	(mat.mat[1][2] * tup.z) + (mat.mat[1][3] * tup.w);
	ret.z = (mat.mat[2][0] * tup.x) + (mat.mat[2][1] * tup.y) + \
	(mat.mat[2][2] * tup.z) + (mat.mat[2][3] * tup.w);
	ret.w = (mat.mat[3][0] * tup.x) + (mat.mat[3][1] * tup.y) + \
	(mat.mat[3][2] * tup.z) + (mat.mat[3][3] * tup.w);
	return (ret);
}
